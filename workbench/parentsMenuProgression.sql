...
WHERE ((treccprod.users.user_type IS NULL OR treccprod.users.user_type = "Parent") AND
treccprod.users.created_at >= '2019-02-09 00:00:00')
ORDER BY treccprod.interactions.created_at DESC;


#CASE treccprod.interaction_data.value
#	WHEN 'UnitSummary_Unit1' THEN 1 AS `treccprod.interaction_data.valueExtract`
#    WHEN 'UnitSummary_Unit2' THEN 2 AS  `treccprod.interaction_data.valueExtract`
#END