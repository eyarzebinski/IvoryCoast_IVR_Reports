...
UASdata_learningCurve_trial_oneLinePerStudentOpp = UASdata_learningCurve_dataPrep %>%
  ...
  summarize(errorRate_trial = mean(rollingAverage_trial)
...
UASdata_learningCurve_syllable_oneLinePerStudentOpp = UASdata_learningCurve_dataPrep %>%
  ...
  summarize(errorRate_syllable = mean(rollingAverage_syllable)
...
UASdata_learningCurve_syllable_oneLinePerOpp = UASdata_learningCurve_syllable_oneLinePerStudentOpp %>%
  #group_by(passedUnit1, treccId_phoneId, cmsQuestions.syllable_id, UAS.unit_id, opportunity_syllable) %>%
...
message(
  paste0(
    paste0("Result: ",
         ifelse(t.test(UASdata_learningCurve_trial_comparison$maxOpportunity_trial~UASdata_learningCurve_trial_comparison$passedUnit1)[["p.value"]]< 0.05,"*Significant difference* between children who passed / did not pass Unit 1.","No significant difference between children who passed / did not pass Unit 1.")), "\n","\n",
...
message(
  paste0(
    paste0("Result: ",
         ifelse(t.test(UASdata_learningCurve_syllable_comparison$maxOpportunity_syllable~UASdata_learningCurve_syllable_comparison$passedUnit1)[["p.value"]]< 0.05,"*Significant difference* between children who passed / did not pass Unit 1.","No significant difference between children who passed / did not pass Unit 1.")), "\n","\n",
...
#> paste0('y =', round(coef(test)[[2]],3), '*x', ' + ', round(coef(test)[[1]],2))
```
...
#and run a t-test
t.test(attPerQuestionType$avgQuestionTypeAttemptsPerStudent~attPerQuestionType$passedUnit1) # where y is numeric and x is a binary factor

#plot the averages
attPerQuestionType %>%
  group_by(passedUnit1) %>%
  ggplot() +
  geom_bar(aes(x = as.factor(passedUnit1), y = avgQuestionTypeAttemptsPerStudent, group = as.factor(passedUnit1)),
           position = "dodge", stat = "summary", fun.y = "mean") +
  #geom_errorbar(width = .1, aes(x = passedUnit1, ymin = mean(totalCalls)-sd(totalCalls), ymax = mean(totalCalls)+sd(totalCalls)), inherit.aes = FALSE) +
  labs(x = "Passed Unit 1", y = "Avg Attempts Per Question Type")


message(
  paste0("Result: ",
         ifelse(t.test(attPerQuestionType$avgQuestionTypeAttemptsPerStudent~attPerQuestionType$passedUnit1)[["p.value"]]< 0.05,"*Significant difference* between children who passed / did not pass Unit 1.","No significant difference between children who passed / did not pass Unit 1.")), "\n","\n",
  paste0(
    paste0("Avg attempts per question for children not passing Unit 1 = ", round(mean(attPerQuestionType$avgQuestionTypeAttemptsPerStudent[attPerQuestionType$passedUnit1 == 0]),2),"; SD = ", round(sd(attPerQuestionType$avgQuestionTypeAttemptsPerStudent[attPerQuestionType$passedUnit1 == 0]),2)),"\n",
    paste0("Avg attempts per question for children passing Unit 1 = ", round(mean(attPerQuestionType$avgQuestionTypeAttemptsPerStudent[attPerQuestionType$passedUnit1 == 1]),2),"; SD = ", round(sd(attPerQuestionType$avgQuestionTypeAttemptsPerStudent[attPerQuestionType$passedUnit1 == 1]),2))
  )
  )
...
questionsCorrectPerUser = as_tibble(UASdata) %>%
  ...
  group_by(treccId_phoneId) %>%
  mutate(maxUnit = max(UAS.unit_id),
         passedUnit1 = ifelse(UAS.unit_id == 1 & maxUnit != 1, 1, 0)) %>%
  filter(UAS.unit_id == 1) %>%
  group_by(treccId_phoneId, passedUnit1) %>%
  summarize(avg_totalQuestionsCorrectPerLesson = mean(totalQuestionsCorrectPerLesson)) %>%
  ungroup()

#and run a t-test
t.test(questionsCorrectPerUser$avg_totalQuestionsCorrectPerLesson~questionsCorrectPerUser$passedUnit1) # where y is numeric and x is a binary factor

#plot the averages
questionsCorrectPerUser %>%
  group_by(passedUnit1) %>%
  ggplot() +
  geom_bar(aes(x = as.factor(passedUnit1), y = avg_totalQuestionsCorrectPerLesson, group = as.factor(passedUnit1)),
           position = "dodge", stat = "summary", fun.y = "mean") +
  #geom_errorbar(width = .1, aes(x = passedUnit1, ymin = mean(totalCalls)-sd(totalCalls), ymax = mean(totalCalls)+sd(totalCalls)), inherit.aes = FALSE) +
...
message(
  paste0("Result: ",
         ifelse(t.test(questionsCorrectPerUser$avg_totalQuestionsCorrectPerLesson~questionsCorrectPerUser$passedUnit1)[["p.value"]]< 0.05,"*Significant difference* between children who passed / did not pass Unit 1.","No significant difference between children who passed / did not pass Unit 1.")), "\n","\n",
  paste0(
    paste0("Avg correct questions per lesson by children not passing Unit = ", round(mean(questionsCorrectPerUser$avg_totalQuestionsCorrectPerLesson[questionsCorrectPerUser$passedUnit1 == 0]),2),"; SD = ", round(sd(questionsCorrectPerUser$avg_totalQuestionsCorrectPerLesson[questionsCorrectPerUser$passedUnit1 == 0]),2)),"\n",
    paste0("Avg correct questions per lesson by children passing Unit 1 = ", round(mean(questionsCorrectPerUser$avg_totalQuestionsCorrectPerLesson[questionsCorrectPerUser$passedUnit1 == 1]),2),"; SD =  ", round(sd(questionsCorrectPerUser$avg_totalQuestionsCorrectPerLesson[questionsCorrectPerUser$passedUnit1 == 1]),2))
  )
  )
...
#and run a t-test
t.test(lessonsAttemptedPerUser$totalLessons~lessonsAttemptedPerUser$passedUnit1) # where y is numeric and x is a binary factor

#plot the averages
lessonsAttemptedPerUser %>%
  group_by(passedUnit1) %>%
  ggplot() +
  geom_bar(aes(x = as.factor(passedUnit1), y = totalLessons, group = as.factor(passedUnit1)),
           position = "dodge", stat = "summary", fun.y = "mean") +
  #geom_errorbar(width = .1, aes(x = passedUnit1, ymin = mean(totalCalls)-sd(totalCalls), ymax = mean(totalCalls)+sd(totalCalls)), inherit.aes = FALSE) +
...
message(
  paste0("Result: ",
         ifelse(t.test(lessonsAttemptedPerUser$totalLessons~lessonsAttemptedPerUser$passedUnit1)[["p.value"]]< 0.05,"*Significant difference* between children who passed / did not pass Unit 1.","No significant difference between children who passed / did not pass Unit 1.")), "\n","\n",
  paste0(
    paste0("Avg lessons started by children not passing Unit 1 = ", round(mean(lessonsAttemptedPerUser$totalLessons[lessonsAttemptedPerUser$passedUnit1 == 0]),2),"; SD = ", round(sd(lessonsAttemptedPerUser$totalLessons[lessonsAttemptedPerUser$passedUnit1 == 0]),2)),"\n",
    paste0("Avg lessons started by children passing Unit 1 = ", round(mean(lessonsAttemptedPerUser$totalLessons[lessonsAttemptedPerUser$passedUnit1 == 1]),2),"; SD =  ", round(sd(lessonsAttemptedPerUser$totalLessons[lessonsAttemptedPerUser$passedUnit1 == 1]),2))
  )
  )
...
#run a t-test
t.test(callsWithAttemptedQuestions$totalCallsWithAttempts~callsWithAttemptedQuestions$passedUnit1) # where y is numeric and x is a binary factor

#plot the averages
callsWithAttemptedQuestions %>%
  group_by(passedUnit1) %>%
  ggplot() +
  geom_bar(aes(x = as.factor(passedUnit1), y = totalCallsWithAttempts, group = as.factor(passedUnit1)),
           position = "dodge", stat = "summary", fun.y = "mean") +
  #geom_errorbar(width = .1, aes(x = passedUnit1, ymin = mean(totalCalls)-sd(totalCalls), ymax = mean(totalCalls)+sd(totalCalls)), inherit.aes = FALSE) +
...
message(
  paste0("Result: ",
         ifelse(t.test(callsWithAttemptedQuestions$totalCallsWithAttempts~callsWithAttemptedQuestions$passedUnit1)[["p.value"]]< 0.05,"*Significant difference* between children who passed / did not pass Unit 1.","No significant difference between children who passed / did not pass Unit 1.")), "\n","\n",
  paste0(
    paste0("Avg calls (with question attempts) by children not passing Unit 1 = ", round(mean(callsWithAttemptedQuestions$totalCallsWithAttempts[callsWithAttemptedQuestions$passedUnit1 == 0]),2),"; SD = ", round(sd(callsWithAttemptedQuestions$totalCallsWithAttempts[callsWithAttemptedQuestions$passedUnit1 == 0]),2)),"\n",
    paste0("Avg calls (with question attempts) by children passing Unit 1 = ", round(mean(callsWithAttemptedQuestions$totalCallsWithAttempts[callsWithAttemptedQuestions$passedUnit1 == 1]),2),"; SD = ", round(sd(callsWithAttemptedQuestions$totalCallsWithAttempts[callsWithAttemptedQuestions$passedUnit1 == 1]),2))
  )
  )
...
#and run a t-test
t.test(callsPerActiveDaysWithAttemptedQuestions$callsPerActiveDays~callsPerActiveDaysWithAttemptedQuestions$passedUnit1) # where y is numeric and x is a binary factor

#plot the averages
callsPerActiveDaysWithAttemptedQuestions %>%
  group_by(passedUnit1) %>%
  ggplot() +
  geom_bar(aes(x = as.factor(passedUnit1), y = callsPerActiveDays, group = as.factor(passedUnit1)),
           position = "dodge", stat = "summary", fun.y = "mean") +
  #geom_errorbar(width = .1, aes(x = passedUnit1, ymin = mean(totalCalls)-sd(totalCalls), ymax = mean(totalCalls)+sd(totalCalls)), inherit.aes = FALSE) +
...
message(
  paste0("Result: ",
         ifelse(t.test(callsPerActiveDaysWithAttemptedQuestions$callsPerActiveDays~callsPerActiveDaysWithAttemptedQuestions$passedUnit1)[["p.value"]]< 0.05,"*Significant difference* between children who passed / did not pass Unit 1.","No significant difference between children who passed / did not pass Unit 1.")), "\n","\n",
  paste0(
    paste0("Avg calls per active days (with question attempts) by children not passing Unit 1 = ", round(mean(callsPerActiveDaysWithAttemptedQuestions$callsPerActiveDays[callsPerActiveDaysWithAttemptedQuestions$passedUnit1 == 0]),2),"; SD = ", round(sd(callsPerActiveDaysWithAttemptedQuestions$callsPerActiveDays[callsPerActiveDaysWithAttemptedQuestions$passedUnit1 == 0]),2)),"\n",
    paste0("Avg calls per active days (with question attempts) by children passing Unit 1 = ", round(mean(callsPerActiveDaysWithAttemptedQuestions$callsPerActiveDays[callsPerActiveDaysWithAttemptedQuestions$passedUnit1 == 1]),2),"; SD = ", round(sd(callsPerActiveDaysWithAttemptedQuestions$callsPerActiveDays[callsPerActiveDaysWithAttemptedQuestions$passedUnit1 == 1]),2))
  )
  )
...
#and run a t-test
t.test(callsPerActiveDaysWithAttemptedQuestions$callsPerAllDays~callsPerActiveDaysWithAttemptedQuestions$passedUnit1) # where y is numeric and x is a binary factor

#plot the averages
callsPerActiveDaysWithAttemptedQuestions %>%
  group_by(passedUnit1) %>%
  ggplot() +
  geom_bar(aes(x = as.factor(passedUnit1), y = callsPerAllDays, group = as.factor(passedUnit1)),
           position = "dodge", stat = "summary", fun.y = "mean") +
  #geom_errorbar(width = .1, aes(x = passedUnit1, ymin = mean(totalCalls)-sd(totalCalls), ymax = mean(totalCalls)+sd(totalCalls)), inherit.aes = FALSE) +
...
message(
  paste0("Result: ",
         ifelse(t.test(callsPerActiveDaysWithAttemptedQuestions$callsPerAllDays~callsPerActiveDaysWithAttemptedQuestions$passedUnit1)[["p.value"]]< 0.05,"*Significant difference* between children who passed / did not pass Unit 1.","No significant difference between children who passed / did not pass Unit 1.")), "\n","\n",
  paste0(
    paste0("Avg calls in call date range (with question attempts) by children not passing Unit 1 = ", round(mean(callsPerActiveDaysWithAttemptedQuestions$callsPerAllDays[callsPerActiveDaysWithAttemptedQuestions$passedUnit1 == 0]),2),"; SD = ", round(sd(callsPerActiveDaysWithAttemptedQuestions$callsPerAllDays[callsPerActiveDaysWithAttemptedQuestions$passedUnit1 == 0]),2)),"\n",
    paste0("Avg calls in call date range (with question attempts) by children passing Unit 1 = ", round(mean(callsPerActiveDaysWithAttemptedQuestions$callsPerAllDays[callsPerActiveDaysWithAttemptedQuestions$passedUnit1 == 1]),2),"; SD =  ", round(sd(callsPerActiveDaysWithAttemptedQuestions$callsPerAllDays[callsPerActiveDaysWithAttemptedQuestions$passedUnit1 == 1]),2))
  )
  )
