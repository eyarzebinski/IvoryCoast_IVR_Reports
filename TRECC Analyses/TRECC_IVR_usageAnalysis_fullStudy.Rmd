...
ggplotly(
  ggplot(data=Qcount_unit_questionType_current,aes(x=total_questionsAttempted,y=avg_mastery, label = treccId_phoneId)) + 
...
interactionsCount_day_FILTER %>%
    ...
    ggplot(aes(x = date,
               ...
               y = as.factor(as.numeric(studyPhoneId)),
               group = studyPhoneId, 
               shape = userRole,
