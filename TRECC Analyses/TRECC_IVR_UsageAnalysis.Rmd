...
####This analysis is only for students who were promoted into subsequent units based on their performance. Students who never passed Unit 1 are excluded from this analysis. Students who were manually promoted into later units have the manually promoted unit and the prior unit filtered out. For example, if a student achieved the promotion threshold for unit 1 and unit 2 on their own, and then while they were in the middle of unit 3 were promoted to unit 4, I would filter out unit 3 and unit 4, but keep unit 1 and unit 2.
...
<!-- #             avg_DaysBeforePromotionToCurrentUnit = round(mean(daysCalledInCurrentUnitBeforePromotion),2), -->
<!-- #             sd_DaysBeforePromotionToCurrentUnit = round(sd(daysCalledInCurrentUnitBeforePromotion),2), -->
<!-- #             avgQ_ForPromotionToCurrentUnit = round(mean(questionsAnsweredInCurrentUnitBeforePromotion),2), -->
<!-- #             sdQ_ForPromotionToCurrentUnit = round(sd(questionsAnsweredInCurrentUnitBeforePromotion),2), -->
<!-- #             minQ_ForPromotionToCurrentUnit = min(questionsAnsweredInCurrentUnitBeforePromotion), -->
<!-- #             maxQ_ForPromotionToCurrentUnit = max(questionsAnsweredInCurrentUnitBeforePromotion)) -->
<!-- #  -->
...
<!-- promotionQuestions %>% -->
<!--   ggplot(aes(x=daysCalledIVR,y=questionsAnsweredInCurrentUnitBeforePromotion, color=UAS.unit_id)) + -->
<!--   geom_point() + -->
