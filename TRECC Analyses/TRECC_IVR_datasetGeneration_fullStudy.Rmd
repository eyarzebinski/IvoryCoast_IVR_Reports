...
#INTERACTIONS
<!-- ```{python interactions new from vikram} -->
<!-- # encoding=utf8 -->
<!-- import csv -->
<!-- import os -->
<!-- import pickle -->
...
<!-- cursor = cnx.cursor() -->
<!-- FILE_NAME = 'interactions_id_key.txt' -->


<!-- def get_start_interactions_id(): -->
<!--     dict2 = {} -->
...
<!-- def write_last_id(interactions_id): -->
<!--     dict = {'last_id': interactions_id} -->
...
<!-- INTERACTIONS_START_ID = find_start_id('interaction_data', INTERACTIONS_START, "id", "created_at") -->
<!-- INTERACTIONS_END_ID = find_start_id('interaction_data', INTERACTIONS_END, "id", "created_at") -->
...
<!-- INTERACTIONS_START = get_start_interactions_id() -->
...
<!-- CDR_END_ID = find_start_id('cdr_ivr01', CDR_END, "clid", "calldate") -->
