...
#run cleaning script
suppressWarnings(suppressMessages(source("TRECC_dataPrep_fullStudy_HD.R")))
...
# sum = Qcount_unit_questionType_all %>%
#   filter(userRole == "child") %>%
#   ungroup() %>%
...
# 
# write.csv(sum,"childUsers_all_forBen_20190509.csv", row.names = F)
...
###Current child progress in unit
...
#ggplotly(
  ggplot(data=Qcount_unit_questionType_current,aes(x=as.numeric(total_questionsAttempted),y=as.numeric(avg_mastery))) + 
  #geom_point(aes(alpha = -n_daysSinceLastLesson)) +
  geom_jitter(aes(col = n_trialsComplete), width = 1) +
  #geom_point() +
  labs(x = "Questions Attempted", y = "Mastery Score", col = "Trials \nComplete") +
  facet_wrap(~ UAS.unit_id, ncol = 4) +
  ggtitle("Child users: mastery & attempted questions - number of complete trials") +
   #guides(fill=guide_legend(title="Trials Complete")) +
  scale_color_manual(values=c("grey56","#53B400","tan1","#C77CFF","#F8766D","#00BFC4"))
#)
...
suppressWarnings({  
interactionsCount_day = interactionsData %>%
  ...
  group_by(treccId_phoneId, studyPhoneId, userRole, village, school, village_school, date, CONCAT_treccIdStudyId_studyPhoneId_userRole_village_date) %>%
  summarize(n = n()) %>%
  mutate(n = NULL,
         callMade = 1) %>%
    ungroup()
...
names(shapes) <- unique(interactionsData$userRole)
...
interactionsCount_day_FILTER %>%
    ...
    labs(y = "Study Phone Id", shape = "User", fill = "Attempted \nQuestion \nOn Call") +
...
message("Average all unique users calling system per week: ",round(mean(usersPerWeek_usage$count[usersPerWeek_usage$action == "callingSystem"]),2),"; sd: ",round(sd(usersPerWeek_usage$count[usersPerWeek_usage$action == "callingSystem"]),2))
message("Average all unique users attempting questions per week: ",round(mean(usersPerWeek_usage$count[usersPerWeek_usage$action == "attemptingQuestions"]),2),"; sd: ",round(sd(usersPerWeek_usage$count[usersPerWeek_usage$action == "attemptingQuestions"]),2))
...
message("Average unique child users calling system per week: ",round(mean(usersPerWeek_usage$count[usersPerWeek_usage$action == "callingSystem"]),2),"; sd: ",round(sd(usersPerWeek_usage$count[usersPerWeek_usage$action == "callingSystem"]),2))
message("Average unique child users attempting questions per week: ",round(mean(usersPerWeek_usage$count[usersPerWeek_usage$action == "attemptingQuestions"]),2),"; sd: ",round(sd(usersPerWeek_usage$count[usersPerWeek_usage$action == "attemptingQuestions"]),2))
...
message("Average all unique users calling system per day: ",round(mean(usersPerDay_usage$count[usersPerDay_usage$action == "callingSystem"]),2),"; sd: ",round(sd(usersPerDay_usage$count[usersPerDay_usage$action == "callingSystem"]),2))

message("Average all unique users attempting questions per day: ",round(mean(usersPerDay_usage$count[usersPerDay_usage$action == "attemptingQuestions"]),2),"; sd: ",round(sd(usersPerDay_usage$count[usersPerDay_usage$action == "attemptingQuestions"]),2))
...
message("Average unique child users calling system per day: ",round(mean(usersPerDay_usage$count[usersPerDay_usage$action == "callingSystem"]),2),"; sd: ",round(sd(usersPerDay_usage$count[usersPerDay_usage$action == "callingSystem"]),2))

message("Average unique shild users attempting questions per day: ",round(mean(usersPerDay_usage$count[usersPerDay_usage$action == "attemptingQuestions"]),2),"; sd: ",round(sd(usersPerDay_usage$count[usersPerDay_usage$action == "attemptingQuestions"]),2))
...
message("Average all unique users calling system per day: ",round(mean(weeksPerUser_usage$count[weeksPerUser_usage$action == "callingSystem"]),2),"; sd: ",round(sd(weeksPerUser_usage$count[weeksPerUser_usage$action == "callingSystem"]),2))

message("Average all unique users attempting questions per day: ",round(mean(weeksPerUser_usage$count[weeksPerUser_usage$action == "attemptingQuestions"]),2),"; sd: ",round(sd(weeksPerUser_usage$count[weeksPerUser_usage$action == "attemptingQuestions"]),2))
...
message("Average unique child users calling system per day: ",round(mean(weeksPerUser_usage$count[weeksPerUser_usage$action == "callingSystem"]),2),"; sd: ",round(sd(weeksPerUser_usage$count[weeksPerUser_usage$action == "callingSystem"]),2))

message("Average unique child users attempting questions per day: ",round(mean(weeksPerUser_usage$count[weeksPerUser_usage$action == "attemptingQuestions"]),2),"; sd: ",round(sd(weeksPerUser_usage$count[weeksPerUser_usage$action == "attemptingQuestions"]),2))
...
message("Average days called system per all users: ",round(mean(daysPerUser_usage$daysCallingSystem),2),"; sd: ",round(sd(daysPerUser_usage$daysCallingSystem),2))
message("Average days attempted questions per all users: ",round(mean(daysPerUser_usage$daysAttemptedQuestions),2),"; sd: ",round(sd(daysPerUser_usage$daysAttemptedQuestions),2))
...
message("Average days called system per child users: ",round(mean(daysPerUser_usage$daysCallingSystem),2),"; sd: ",round(sd(daysPerUser_usage$daysCallingSystem),2))
message("Average days attempted questions per child users: ",round(mean(daysPerUser_usage$daysAttemptedQuestions),2),"; sd: ",round(sd(daysPerUser_usage$daysAttemptedQuestions),2))
...
ggplot(usersPerDay_lessons, aes(date,as.integer(uniqueUsers), fill = factor(userRole))) +
  ...
  labs(y = "uniqueUsers") +
  scale_fill_manual(values=c("gold3","grey56","dodgerblue")) +
  guides(fill=guide_legend(title="Users Attempting Questions")) +
...
ggplot(usersPerDay_calling, aes(date,as.integer(uniqueUsers), fill = factor(userRole))) +
  ...
  labs(y = "uniqueUsers") +
  scale_fill_manual(values=c("gold3","grey56","dodgerblue")) +
  guides(fill=guide_legend(title="Users Initiating a Call")) +
